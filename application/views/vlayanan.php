...
<div class="ui main container">
	<div class="ui breadcrumb">
		...
		<div class="active section">Layanan</div>
	</div>
	<h2>Layanan</h2>
	<div class="ui grid">
		<div class="thirteen wide column">
			...
			<ul>
				<li><strong>Mandiri Kredit Mobil:</strong> siap memenuhi kebutuhan konsumen  dalam pembiayaan  mobil baru maupun bekas, semua merek mobil.</li>
				<li><strong>Mandiri Kredit Motor:</strong> siap memenuhi kebutuhan konsumen dalam pembiayaan sepeda motor baru.</li>
			</ul>
